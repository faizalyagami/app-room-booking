...
class PlottedRoomSeeder extends Seeder
{
    public function run()
    {
        ...
        $startDate = Carbon::create(2026, 3, 1);   // 1 Maret 2026 (mulai genap)
        $endDate = Carbon::create(2026, 7, 10);    // 10 Juli 2026 (estimasi akhir)
                    ...
                    foreach ($slots as [$start, $end]) {
                        ...
                        if (!$exists) {
                            BookingList::create([
                                ...
                                'purpose' => 'Jadwal tetap laboratorium (plot semester genap 25/26)',
                                'is_fixed' => true,
                            ]);
                            $count++;
                        }
        ...
        $this->command->info("✅ {$count} jadwal plot laboratorium semester genap 2025/2026 berhasil ditambahkan!");
    }
}