...
@section('section-title')
  Buat Booking Alat Test
@endsection 
    
@section('section-lead')
  Silakan isi form di bawah ini untuk membuat booking Alat Test.
@endsection
  ...
  <div class="col ">
    <div class="card">
      <div class="card-body">
        ...
        <form action="{{ route('my-booking-alat-test-list.store') }}" method="post" name="form-booking" id="form-booking">
          @csrf
