...
@push('after-script')
    <script>
        ...
        function updateBookingDetail(id) {
            ...
            $.ajax({
                url: '{{ route('user.calendar.booking.detail', ':id') }}'.replace(':id', id),
                type: 'GET',
                dataType: 'json',
                timeout: 10000,
                ...
                error: function(xhr, status, error) {
                    ...
                    if (xhr.status === 404) {
                        ...
                        errorMsg = 'Anda tidak memiliki akses untuk melihat detail booking ini.';
                    ...
                    console.error('Booking Detail Error:', {
                        status: xhr.status,
