...
@section('title', 'Data List Alat Test')
...
@section('section-lead')
  Berikut ini adalah daftar seluruh alat test psikologi.
@endsection
...
@section('content')
  ...
  @component('components.datatables')
    ...
    @slot('buttons')
      <a href="{{ route('room.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i>&nbsp;Tambah Alat Test</a>
    @endslot
